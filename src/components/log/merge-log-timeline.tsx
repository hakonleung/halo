...
import type { GoalCategory, GoalStatus } from '@/types/goal-client';
import type { BehaviorCategory } from '@/types/behavior-server';
import { FilterGroups } from '@/components/shared/filter-groups';
